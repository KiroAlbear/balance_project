...
class _$HomeModelImpl implements _HomeModel {
  const _$HomeModelImpl({this.name, this.description});
  ...
  @override
  String toString() {
    return 'HomeModel(name: $name, description: $description)';
  }
...
abstract class _HomeModel implements HomeModel {
  const factory _HomeModel({final String? name, final String? description}) =
      _$HomeModelImpl;
